...
<body>
        ...
        <div class="container-fluid px-3 px-md-4">
            <div class="d-flex align-items-center justify-content-between" style="height: 64px;">
                <a class="brand d-flex align-items-center gap-2 text-decoration-none" href="./index.php">
                    <span class="brand-mark d-flex align-items-center justify-content-center rounded-3">
                        <svg viewBox="0 0 24 24" class="svg-icon">
                            <path d="M3 6h12a2 2 0 0 1 2 2v2h2.5a2.5 2.5 0 0 1 1.7 1l1.8 3.1V17h-2.2a2.5 2.5 0 0 1-4.6 0H8.1a2.5 2.5 0 0 1-4.6 0H1V8a2 2 0 0 1 2-2Zm1 2v7h.4a2.5 2.5 0 0 1 4.6 0H16v-5h-1V8H4Zm14 4v3h.1a2.5 2.5 0 0 1 4.6 0h.1v-.5L19.5 12H18ZM5.8 18a1.1 1.1 0 1 0 0-2.2 1.1 1.1 0 0 0 0 2.2Zm12 0a1.1 1.1 0 1 0 0-2.2 1.1 1.1 0 0 0 0 2.2Z" />
                        </svg>
                    </span>
                    <strong class="brand-name d-none d-sm-inline"
                        data-i18n="brand">
                ...
                <div class="header-actions d-flex align-items-center gap-1 gap-sm-2">
                    ...
                    <a href="/assets/logout.php" class="logout btn btn-link text-decoration-none" data-i18n="logout">↪&nbsp; Logout</a>
                </div>
            </div>
        </div>
    </header>
    <main id="app" class="page container-fluid px-3 px-md-4 px-lg-5 py-4 py-md-5">
        <div class="page-heading mb-4">
            <div>
                <h1 class="mb-1 fw-bold" data-i18n="title">
                    User management
                </h1>
                <p class="subtitle mb-0" data-i18n="subTitle">
                    List of users that are registered in the system.
                </p>
            </div>
        </div>
        <div class="table-responsive users-table-wrapper rounded-3">
            <table id="usersTable"
        ...
        <a href="../PHP/user.php" class="button btn btn-primary mt-3" data-i18n="newUser">Add new user</a>
    </main>
